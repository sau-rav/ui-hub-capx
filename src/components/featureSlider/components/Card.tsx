...
>(({ card, visible }, ref): JSX.Element => {
  ...
  return (
    <div
      className={
        visible
          ? "flex text-white w-full border-8 border-transparent flex-none rounded h-100 lg:h-106 md:h-104"
          : "flex text-white w-full border-8 border-transparent flex-none rounded h-98 lg:h-104 md:h-102"
      }
      ref={ref}
    >
      <div
