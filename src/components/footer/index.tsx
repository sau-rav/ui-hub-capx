...
const Footer = (): JSX.Element => {
  ...
  return (
    <div className="relative flex items-center justify-center pt-[60px] pb-[40px] bg-grey 2xl:bg-[#000000] mt-[40px] 2xl:mt-[0] rounded-t-[50px]">
      <div className="2xl:flex 2xl:bg-[#000000] 2xl:w-3/4 2xl:rounded-tl-[50px]">
        <div>
        ...
        <div className="bg-grey 2xl:w-1/4 mt-[11spx] rounded-br-[50px] flex flex-col">
          ...
          <div className="flex items-center 2xl:justify-center h-full pl-[30px] 2xl:pl-[0]">
            <div className="grid grid-cols-4 gap-[15px] md:gap-[30px] lg:gap-[45px] 2xl:grid-cols-2 2xl:gap-[65px]">
              ...
              <a
                ...
                rel={"noreferrer"}
              >
                <InstagramIcon sx={{ fontSize: iconSize, color: "#EDAF36" }} />
              </a>
              <a
