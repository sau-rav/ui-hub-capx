export const TextComponent = () => {
  return (
    <div className="md:p-8 text-center">
      <div className="tracking-wider mb-6 text-white text-lg md:text-xl font-semibold leading-10 md:leading-12 ">
      ...
      <div className="tracking-wider mt-4 text-base md:text-xl font-medium leading-7  text-yellow-600">
