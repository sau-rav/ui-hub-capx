        ...
        {shareArray?.map((x, index) => (
          ...
          >
            <div className="rounded-full bg-gray-950 p-4 gap-3 text-white flex items-center justify-center">
              ...
              <div className="text-xs font-montserrat font-extrabold italic text-base md:text-base lg:text-xl xl:text-lg leading-5 sm:leading-6 lg:leading-7 xl:leading-6 tracking-widest">
                {x?.name}
              </div>
            </div>
          </div>
