...
type FeatureCard = {
  title: string;
  description: string;
  image: keyof typeof SRC_TO_IMAGE;
};
    ...
    <div
      className={
        visible
          ...
          : "flex text-white w-full border-2 border-transparent flex-none rounded h-5/6 lg:h-96 md:h-90 "
      }
      ref={ref}
    >
      <div className={CONTAINER_CLASS_NAME}>
        ...
        <div
          className="flex-1 flex w-full items-end justify-center bg-feature-image-2"
          style={{
