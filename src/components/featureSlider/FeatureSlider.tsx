...
export const FeatureSlider = () => {
  ...
  return (
    <div className="flex flex-col justify-center text-white items-center gap-16 lg:py-48 py-12 md:py-24 font-montserrat w-full">
      ...
      <div className="w-full px-8 slider-container">
        <Slider {...settings}>
